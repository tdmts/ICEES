...
"""Zet een hoofdstuk van de syllabus-Word om naar HTML-pagina's.
    ...
    python scripts/import-syllabus.py --hoofdstuk 1 --voorwoord
    python scripts/import-syllabus.py --hoofdstuk 2 --docx "pad/naar/syllabus.docx"

De Word is de HERKOMST van de tekst, niet de bron ervan: na de import is de HTML
de bron en wordt de Word gearchiveerd. Dit script draait dus eenmalig per
hoofdstuk, zoals import-brightspace.py, en nooit in CI of in de Stop-hook.

WAT ERUIT KOMT

    Theorie/Syllabus/Theorie/<Hoofdstuk>/Overzicht.html   kernpunten en studievragen
    Theorie/Syllabus/Theorie/<Hoofdstuk>/<Sectie>.html    een pagina per Heading 2
    img/syllabus-<nn>-<slug>-<kk>.png                     de afbeeldingen
    Theorie/Syllabus/IMPORT.md                            wat de import niet zeker wist
...
DOCX = (Path.home() / "OneDrive - Hogeschool Gent" / "EDU" / "2025-2026"
        / "Industriële computers en embedded systems" / "Theorie" / "Syllabus"
        / "Industriële computers en embedded systems_.docx")
UIT = REPO / "Theorie" / "Syllabus" / "Theorie"
IMG = REPO / "img"
IMPORT_LOG = REPO / "Theorie" / "Syllabus" / "IMPORT.md"
...
def main():
    ...
    p.add_argument("--docx", default=str(DOCX))
    args = p.parse_args()
